...
import laurarose from 'C:/Users/vicky/OneDrive/Desktop/New folder/my-protfolio/src/lauraimg-edited.png';
import kamaneimg from 'C:/Users/vicky/OneDrive/Desktop/New folder/my-protfolio/src/kamaneimg-edited.png';
import sabinaimg from 'C:/Users/vicky/OneDrive/Desktop/New folder/my-protfolio/src/sabinaimg-edited.png';
    ...
    return (
        <div>
            ...
            <div className="row margin3 mb-3">
                <div className="proj">
                    <a href="https://www.laurarosesweetdreams.co.uk/"><img src={laurarose} className="project-img"/></a>
                    <div>
                ...
                <div className="proj">
                    <div className="proj-info">
                        <h3>Django based Ecommerce Website</h3>
                ...
                <div className="proj">
                    <a href="https://kamane.herokuapp.com/"><img src={kamaneimg} className="project-img"/></a>
                    <div className="proj-info">
                        <h3>A Dynamic Django based school website</h3>
